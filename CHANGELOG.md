...
### Changed
- **Documentation parity** with pm-skills v2.8.2: versioning concepts page, git-revision-date plugin, custom CSS, F-12 effort brief.

### Release Notes
- Documentation-only alignment. No code changes.
